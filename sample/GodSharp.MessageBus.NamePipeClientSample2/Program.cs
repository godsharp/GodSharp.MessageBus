...
namespace GodSharp.MessageBus.NamePipeClientSample1
{
    partial class Program
    {
        ...
        {
            Console.WriteLine("Hello GodSharp.MessageBus.NamePipeClientSample2!");
                    ...
                    while (!cts.IsCancellationRequested)
                    {
                        ...
                        switch (i)
                        {
                            ...
                            case 3:
                                ...
                                break;
                            case 4:
                                Bus.Messages.MessageBus.Publish(new TestMessage() { FromId = "002"});
                                break;
                            case 5:
                                Bus.Messages.MessageBus.Publish(new TestMessage() { FromId = "002" }, "handler1");
                                break;
                            case 6:
                                Bus.Messages.MessageBus.Publish(new TestMessage() { FromId = "002" }, "handler2");
                                break;
                            default:
                                continue;
                        }
